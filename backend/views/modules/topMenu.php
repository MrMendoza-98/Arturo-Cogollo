<header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="views/images/brand/logo.svg" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="views/images/brand/sygnet.svg" width="30" height="30" alt="CoreUI Logo">
      </a>
